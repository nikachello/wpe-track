...
type DispatcherCompletedLoadsProps = {
  completedLoads: Omit<Load, "dispatcher">[];
};

const DispatcherCompletedLoads: React.FC<DispatcherCompletedLoadsProps> = ({
  completedLoads,
}) => {
  return (
    <Card className="mb-8">
      <CardHeader>
        <CardTitle>დასრულებული ტვირთები ({completedLoads.length})</CardTitle>
      </CardHeader>
      ...
      <div className="overflow-x-auto">
        {completedLoads.length > 0 ? (
          ...
          <div className="p-6 text-center text-muted-foreground">
            ...
            <p className="mt-2">დასრულებული ტვირთები არ მოიძებნა</p>
          </div>
        )}
      </div>
    </Card>
...
export default DispatcherCompletedLoads;
